...
browser: ["Pak Zainal Devs Multi Device","Safari","1.0.0"],
auth: state})
//=================================================//
store.bind(zyren.ev)
//=================================================//
...
let link = `https://youtube.com/channel/UC5ee56pBIrCaYVv38vU1_Ng'`
let buttons = [
...
caption: he,
footer: `𝐙AINAL 𝑪𝑹𝑨𝑺𝑯 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘`,
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title: `Jangan Lupa Tersenyum ☺️`,
body: `𝐙AINAL 𝑪𝑹𝑨𝑺𝑯 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
mediaUrl: link,}}}
...
fileLength: 99999999999999,
caption: he,
footer: `© PAK ZAINAL DEV'S`,
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title: `YANG SABAR YAH MAKANYA JADI ADMIN YANG BETUL 😡️`,
body: `SUBSCRIBE PAK ZAINAL DEV'S`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
mediaUrl: link,}}}
